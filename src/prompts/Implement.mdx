...
2. `git commit -m "{props.commitPrefix || 'EMOJI'} type(scope): description"` — atomic commits, one logical change per commit. Commit tests and implementation together (TDD pair).
